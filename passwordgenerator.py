...
character_string =string.printable   #string.printable consists all of the letters symbols and numebers required
...
title_label = Label(password_gen, text="Password Generator", font=('NEW TIMES ROMAN',12))
title_label.pack()
